...
class FlowSession(DefaultSession):
    ...
    def garbage_collect(self, latest_time) -> None:
        # Need to make separate threat for Garbage Collection, not functional
...
def generate_session_class(output_mode, output_file):
    return type('NewFlowSession', (FlowSession,), {'output_mode': output_mode, 'output_file': output_file,
    })