...
def get_packet_flow_key(packet, direction) -> tuple:
    """Creates a key signature for a packet.
        ...
        Args: packet: A network packet direction: The direction of a packet
        Returns: A tuple of the String IPv4 addresses of the destination, the source port as an int,
        the time to live value, the window size, and TCP flags.
    """
    if 'TCP' in packet:
        protocol = 'TCP'
    elif 'UDP' in packet:
